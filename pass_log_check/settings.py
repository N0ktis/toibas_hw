"""
Django settings for pass_log_check project.
...
INSTALLED_APPS = [
    ...
    'pass_log_check_app.apps.PassLogCheckAppConfig'
]
...
ROOT_URLCONF = 'pass_log_check.urls'
...
WSGI_APPLICATION = 'pass_log_check.wsgi.application'
